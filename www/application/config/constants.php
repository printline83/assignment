...
// 기본 값
define('DATE', '2026041601');
define('AST', '/www/assets/');
define('IMG', '/www/assets/img/');

// 테이블 상수
define('BS_SESS', 't_Sessions'); // 세션정보
define('PD_INFO', 't_Products'); // 상품정보
define('RS_INFO', 't_Reservations'); // 예약정보
define('PY_INFO', 't_Payments'); // 결제정보
